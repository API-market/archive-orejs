...
/* Public */
function approveTransfer(fromAccountName, toAccountName, tokenAmount, tokenName) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, contract, options;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, this.contract(tokenName, fromAccountName)];
                case 1:
                    _a = _b.sent(), contract = _a.contract, options = _a.options;
                    return [4 /*yield*/, contract.approvemore(fromAccountName, toAccountName, tokenAmount, options)];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
            }
...
function transferToken(fromAccountName, toAccountName, amount, tokenName) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, contract, options;
        return __generator(this, function (_b) {
            switch (_b.label) {
