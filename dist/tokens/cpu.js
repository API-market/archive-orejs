...
function approveCpu(fromAccountName, toAccountName, cpuAmount, memo, permission) {
    if (memo === void 0) { memo = ''; }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    amount = this.getAmount(cpuAmount, TOKEN_SYMBOL);
                    return [4 /*yield*/, this.getCpuBalance(fromAccountName, TOKEN_SYMBOL, CONTRACT_NAME)];
                case 1:
                    fromAccountBalance = _a.sent();
                    if (fromAccountBalance > 0) {
                        return [2 /*return*/, this.approveTransfer(fromAccountName, toAccountName, amount, CONTRACT_NAME, memo, permission)];
                    }
